  ...
  return (
    <section className='MoreAboutMe' id='More'>
      ...
      <div className='MoreAboutMe--item twitch'>
        ...
        <Link to='/twitch' className='MoreAboutMe--twitch btn-twitch' title='Visitar ArmandoCodigo'>
      ...
      <div className='MoreAboutMe--item ibm'>
        ...
        <Link to='/ibm' className='MoreAboutMe--ibm btn-ibm' title='Visitar reto de IBM'>
          <SiIbm size={30} />
      ...
      <div className='MoreAboutMe--item platzi'>
        ...
        <Link to='/platzi' className='MoreAboutMe--platzi btn-platzi' title='Visitar mi perfil de platzi'>
          <SiPlatzi size={20} />
